...
Spec covers multiple independent subsystems. To keep execution testable and low-risk, split into 4 versions:

1. **v1.0 (this file):** Monorepo foundation + AI detection validation-first vertical slice  
2. **v1.1:** Asset inventory + policy orchestration + offboarding  
3. **v1.2:** Compliance engine + evidence workflows  
4. **v2.0:** Incident playbooks + production hardening + pilot readiness

This file implements **v1.0** in detail because it validates the riskiest assumption first.

---

## Monorepo File Structure (v1.0)
...
- **Scope creep risk:** strict v1.0 boundary; defer asset/policy/compliance deep features to v1.1/v1.2/v2.0
...
These will be evaluated for v1.1 based on v1.0 pilot feedback and customer demand.
